...
- No duplication. .col-1-2 == .col-2-4 so why create two selectors?
...
## Installation
1. Import `_landslide.scss` to your project via NPM or by manually copying to vendor folder (`@import "vendor/landslide"`)
...
[These old browsers](https://caniuse.com/#feat=css-featurequeries) just won't parse the CSS written inside of @supports, which contains the Flexbox rules, and will use the `inline-block` based grid.
...
### Why were fraction classes removed?
